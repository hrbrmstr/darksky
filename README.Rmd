...
<!-- [![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/hrbrmstr/darksky?branch=master&svg=true)](https://ci.appveyor.com/project/hrbrmstr/darksky) -->
