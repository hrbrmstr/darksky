...
-   `darksky_api_key` : Get or set DARKSKY\_API\_KEY value
...
-   `plot.darksky` : Plot method for rforecastio objects
...
```
    ...
    ## Observations: 61
    ## Variables: 3
    ## $ time              <dttm> 2016-09-21 08:42:00, 2016-09-21 08:43:00, 2016-09-21 08:44:00, 2016-09-21 08:45:00, 2016...
    ...
    ## Observations: 49
    ## Variables: 16
    ## $ time                <dttm> 2016-09-21 08:00:00, 2016-09-21 09:00:00, 2016-09-21 10:00:00, 2016-09-21 11:00:00, 20...
    ...
    ## $ temperature         <dbl> 62.69, 67.31, 72.11, 75.84, 78.34, 80.17, 82.57, 83.06, 82.22, 79.93, 76.19, 71.37, 67....
    ## $ apparentTemperature <dbl> 62.69, 67.31, 72.11, 75.84, 78.34, 80.24, 81.80, 82.08, 81.32, 79.93, 76.19, 71.37, 67....
    ## $ dewPoint            <dbl> 57.78, 58.82, 59.03, 57.68, 56.15, 55.16, 54.95, 54.56, 53.48, 52.32, 51.73, 51.14, 50....
    ## $ humidity            <dbl> 0.84, 0.74, 0.63, 0.53, 0.47, 0.42, 0.39, 0.38, 0.37, 0.38, 0.43, 0.49, 0.55, 0.58, 0.6...
    ## $ windSpeed           <dbl> 7.04, 7.30, 7.12, 6.36, 6.46, 6.24, 5.82, 5.94, 5.44, 5.16, 4.32, 3.34, 3.30, 3.61, 4.0...
    ## $ windBearing         <int> 291, 297, 299, 301, 293, 284, 275, 272, 269, 264, 261, 253, 252, 255, 260, 266, 271, 27...
    ## $ visibility          <dbl> 9.32, 9.40, 9.91, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00,...
    ## $ cloudCover          <dbl> 0.11, 0.13, 0.17, 0.19, 0.21, 0.21, 0.24, 0.21, 0.17, 0.16, 0.16, 0.19, 0.20, 0.18, 0.1...
    ## $ pressure            <dbl> 1020.71, 1020.13, 1020.23, 1020.28, 1020.19, 1019.96, 1019.74, 1019.55, 1019.40, 1019.4...
    ## $ ozone               <dbl> 268.86, 268.89, 268.71, 268.54, 268.48, 268.42, 268.21, 267.76, 267.15, 266.60, 266.18,...
    ...
    ## $ temperatureMin             <dbl> 60.48, 57.86, 54.91, 42.95, 38.50, 37.21, 40.12, 53.07
    ## $ temperatureMinTime         <dttm> 2016-09-21 07:00:00, 2016-09-22 06:00:00, 2016-09-23 23:00:00, 2016-09-24 23:00...
    ## $ temperatureMax             <dbl> 83.06, 78.83, 76.52, 64.76, 58.40, 63.01, 54.99, 56.48
    ## $ temperatureMaxTime         <dttm> 2016-09-21 15:00:00, 2016-09-22 14:00:00, 2016-09-23 12:00:00, 2016-09-24 14:00...
    ## $ apparentTemperatureMin     <dbl> 60.48, 57.86, 54.91, 40.28, 34.14, 33.64, 40.12, 53.07
    ## $ apparentTemperatureMinTime <dttm> 2016-09-21 07:00:00, 2016-09-22 06:00:00, 2016-09-23 23:00:00, 2016-09-24 23:00...
    ## $ apparentTemperatureMax     <dbl> 82.08, 78.83, 76.52, 64.76, 58.40, 63.01, 54.99, 56.48
    ## $ apparentTemperatureMaxTime <dttm> 2016-09-21 15:00:00, 2016-09-22 14:00:00, 2016-09-23 12:00:00, 2016-09-24 14:00...
    ## $ dewPoint                   <dbl> 55.75, 54.48, 53.50, 39.76, 33.19, 36.34, 43.89, 51.29
    ## $ humidity                   <dbl> 0.65, 0.65, 0.64, 0.63, 0.62, 0.66, 0.87, 0.89
    ## $ windSpeed                  <dbl> 4.66, 1.67, 3.81, 6.46, 7.01, 2.88, 4.35, 8.62
    ## $ windBearing                <int> 276, 173, 253, 314, 312, 277, 7, 59
    ## $ visibility                 <dbl> 9.65, 10.00, 10.00, 10.00, NA, NA, NA, NA
    ## $ cloudCover                 <dbl> 0.16, 0.10, 0.50, 0.06, 0.00, 0.05, 0.92, 1.00
    ## $ pressure                   <dbl> 1019.57, 1020.49, 1015.55, 1018.06, 1019.44, 1019.53, 1019.43, 1024.68
    ...
    ## Observations: 1
    ## Variables: 17
    ## $ time                 <dttm> 2016-09-21 08:42:49
    ## $ summary              <chr> "Clear"
    ## $ icon                 <chr> "clear-day"
    ## $ nearestStormDistance <int> 73
    ## $ nearestStormBearing  <int> 217
    ## $ precipIntensity      <int> 0
    ## $ precipProbability    <int> 0
    ## $ temperature          <dbl> 65.98
    ## $ apparentTemperature  <dbl> 65.98
    ## $ dewPoint             <dbl> 58.57
    ## $ humidity             <dbl> 0.77
    ## $ windSpeed            <dbl> 7.22
    ## $ windBearing          <int> 295
